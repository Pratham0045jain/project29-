...
function setup() {
  ...
  //level2
  block7 = new Box(540,200,40,50,"red");
  block8 = new Box(580,200,40,50,"red");
  block9 = new Box(620,200,40,50,"red");
  block10 = new Box(660,200,40,50,"red");
  block11= new Box(700,200,40,50,"red");

  //leve3
  block12 = new Box(580,150,40,50,"green");
  block13 = new Box(620,150,40,50,"green");
  block14 = new Box(660,150,40,50,"green");

  //level4
  block15 = new Box(620,100,40,50,"yellow");
  ...
  //level2
  block21 = new Box(960,100,40,50,"red");
  block22 = new Box(1000,100,40,50,"red");
  block23 = new Box(1040,100,40,50,"red");

  //level3
  block24 = new Box(1000,50,40,50,"green");
